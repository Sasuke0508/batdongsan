...
import { ArrowRight, Clock } from "react-bootstrap-icons";
    ...
    const tabs = [
            ...
            content: [
                {
                    ...
                    image_url: "https://file4.batdongsan.com.vn/crop/610x342/2022/11/24/PHJN6Zw0/20221124160930-e605.jpg",
                    created_at: "1 ngày trước",
                },
                {
                    id: 1,
                    title: "Tìm Phòng Trọ Giá Rẻ",
                    image_url: "https://file4.batdongsan.com.vn/crop/610x342/2022/12/20/JGcIp0rf/20221220143052-ebbd.jpg",
                    created_at: "1 ngày trước",
                },
                {
                    id: 2,
                    title: "Cập Nhật Giá Chung Cư Quận 5 Mới Nhất Tháng 12/2022",
                    image_url: "https://file4.batdongsan.com.vn/crop/610x342/2022/11/23/wxbwknn6/20221123151428-109e.jpg",
                    created_at: "1 ngày trước",
                },
                {
                    id: 3,
        ...
        },
        {
            ...
            content: [
                {
                    id: 0,
                    title: "Nhà Trọ Quanh Khu Vực Bách-Kinh-Xây",
                    image_url: "https://file4.batdongsan.com.vn/crop/610x342/2022/09/12/eCGLjNi5/20220912083354-b7e5.jpg",
                    created_at: "1 ngày trước",
                },
                {
                    id: 1,
        ...
        <div className="news page-container-md mt-5">
            <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex">
                    {tabs.map((item, index) => (
                        <div
                            className={`mx-2 news__tab ${selectedTab === item.id ? "news__tab--selected" : ""}`}
                            key={index}
            ...
            <div className="mt-3 news__content">
                <Row>
                    <Col md={6}>
                        <div>
                            <img alt="product-demo" src={tabs[selectedTab].content[selectedContent].image_url} />
                    ...
                    <Col md={6}>
                        {tabs[selectedTab].content.map((item, index) => (
                            <div key={index} className="news__content-header" onMouseOver={() => handleClickContent(item.id)}>
                                <div>
                                    <h6>{item.title}</h6>
                                </div>
                                <hr />
